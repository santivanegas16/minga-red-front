    ...
    return (
        <div className='relative bg-white w-[325px] h-[158px] rounded-[10px] flex justify-between overflow-hidden items-center mt-8 mb-4 border border-gray-200'>
            ...
            <div className='w-[136px] h-[47px]'>
                ...
                <div className=' flex'>
                    <Anchor to={'/manga/' + manga_id + '/1'} className="transition hover:scale-110 mt-4 cursor-pointer w-[65px] h-[30px] rounded-[50px] text-white font-poppins font-medium text-[12px] leading-[11.42px] lg:flex justify-center items-center hidden" style={{ backgroundColor: `${hover}`, color: `${color}` }}>Editar</Anchor>
