...
export default function Welcome() {
  return (
    <div className="text-center lg:text-start text-white flex flex-col justify-center items-center lg:items-start lg:ml-[108px] absolute inset-y-1/2 inset-x-5 lg:block  lg:top-[225px]">
      ...
      <Anchor to='/signin' className='bg-white text-orange-500 text-xl lg:text-2xl cursor-pointer font-roboto font-medium py-[15.5px] lg:py-[11.5px] w-[363px] max-[380px]:w-[300px] lg:w-[240px] rounded-md lg:block lg:text-center'>Sign In!</Anchor>
    </div>
  )
}
