    ...
    <main className="w-full min-h-screen flex justify-center bg-white pb-[30px]">
      <div className="w-1/2 flex flex-col items-center justify-center ">
        ...
        <form action="" className="mt-5 flex flex-col w-full items-center justify-center">
          ...
          <label
            htmlFor=""
            className="flex justify-center items-center w-[80%] rounded-lg hover:cursor-pointer hover:bg-gradient-to-r from-[#FF5722] to-[#F97316] p-1 border-2"
          >
            ...
            <div className="bg-white flex p-2 w-full justify-between">
              ...
              <div className="flex items-center justify-center border-2 hover:bg-[#FF5722] rounded-full h-[25px] w-[25px]">
          ...
          <label
            htmlFor=""
            className="flex mt-5 justify-center items-center w-[80%] rounded-lg hover:cursor-pointer hover:bg-gradient-to-r from-[#FF5722] to-[#F97316] p-1 border-2"
          >
            <input type="radio" name="author" id="" className="hidden" />
            <div className="bg-white flex p-2 w-full justify-between">
                <div className="flex w-full">
